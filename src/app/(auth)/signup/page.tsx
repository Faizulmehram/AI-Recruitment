      ...
      <section className="flex items-center justify-center py-12 px-6 sm:px-10">
        <div className="w-[531px] h-[838px] space-y-11">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-[1.8rem] font-bold">Create Account</h1>
            <p className="text-[0.9rem] text-black">Signup to create your account</p>
          </div>
          ...
          <p className="mt-10 text-center text-[0.95rem] text-gray-600">
            ...
            <Link href="/login" className="text-[#0ad3f2] hover:underline font-medium text-[0.95rem]">Login</Link>
          </p>
        </div>
      </section>
    </main>
